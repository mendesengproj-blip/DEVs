...
Paper~I~\cite{DEV1} introduced Vacuum Excitation Dynamics
...
Paper~II~\cite{DEV2} demonstrated cosmological stability of
...
% ------------------------------------------------------------
\input{nonlocal_operator_section.tex}
...
programme of Calcagni, in which gravitational dynamics is
governed by $(-\Box)^\alpha$ with non-integer $\alpha$;
(ii)~the nonlocal infrared modification of general
relativity by Maggiore and Mancarella, motivated by quantum
effective actions; and (iii)~the AeST/TeVeS family
of disformal-stress theories of Skordis and Z\l{}o\'snik,
